...
if (paralisis==0)
{
	...
	if ( (presiona[tecla_espacio] || presiona[mousex] || presiona[tocar1]) && contador_pulsa>0 )
	{
	...
	if ((presiona[tecla_espacio] || presiona[mousex] || presiona[tocar1])==0){contador_pulsa=8;}
...
{
	if ((presiona[tecla_espacio] || presiona[mousex] || presiona[tocar1])==1 && contador_perdiste==0){paralisis=0; guerrero.y=100; tubo1.x=-100; tubo2.x=1500; tubo2.y=-300;  puntos_sub=0; puntos=0;}	
